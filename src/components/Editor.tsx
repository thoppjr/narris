...
function Toolbar({ editor, onToggleFindReplace, onToggleSprint, onSplit, onMerge, canMerge, onInsertFootnote, onInsertTextMessage, onToggleDyslexic, dyslexicFont }: {
  ...
  return (
    <div className="flex-1 flex flex-col bg-white dark:bg-stone-900 relative">
      ...
      <div className="flex-1 overflow-y-auto">
        <div className={`max-w-3xl mx-auto px-12 py-10 ${dyslexicFont ? "font-opendyslexic" : ""}`}
